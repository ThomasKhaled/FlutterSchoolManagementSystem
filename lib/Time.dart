...
class Time extends StatefulWidget {
  ...
  const Time({Key key, this.recordName, this.id,this.listOfClasses}) : super(key: key);
  ...
  Future up(QueryDocumentSnapshot x) async {
    ...
    await getB4Updating().whenComplete((){
      ...
      docRef.set({
        ...
        'emte7anNos3am' : double.tryParse(nos3amC.text.toString()),
        'kenisaO5ra' : KenisaO5raC.text.toString(),
        'ebtyWeAl7an' : ebtyWeAl7anC.text.toString(),
        'a5erEl3am' : double.tryParse(a5erEl3amC.text.toString()),
        'mo2tamar' : mo2tamarC.text.toString(),
        'shafawy' : shafawyC.text.toString(),
        ...
        'totalMosab2at' : tempTotalMosab2at,
                      ...
                      if(!f3 ){
                        ...
                        if(!f2){
                          ...
                          setState(() {
                            ...
                            nos3amC.text = element.data()['emte7anNos3am'].toString();
                            ebtyWeAl7anC.text = element.data()['ebtyWeAl7an'];
                            a5erEl3amC.text = element.data()['a5erEl3am'].toString();
                            mo2tamarC.text = element.data()['mo2tamar'];
                            shafawyC.text = element.data()['shafawy'];
                            _dropdownMenuYesOrNo.forEach((e) {
